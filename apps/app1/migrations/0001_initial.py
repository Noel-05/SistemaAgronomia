    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hora_entrada', models.CharField(max_length=1)),
                ('actividad_realizada', models.CharField(max_length=50)),
                ('hora_salida', models.CharField(max_length=1)),
                ('horas_realizadas', models.CharField(max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departamento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.Departamento')),
